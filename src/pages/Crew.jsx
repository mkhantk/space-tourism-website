...
function Crew() {
  ...
  return (
    currentData && (
      <main className="min-h-screen bg-blue-bg transition-colors duration-700 bg-[url('/assets/crew/background-crew-mobile.jpg')]  md:bg-[url('/assets/crew/background-crew-tablet.jpg')] lg:bg-[url('/assets/crew/background-crew-desktop.jpg')] bg-cover bg-center bg-no-repeat pt-20 lg:pb-12 flex flex-col justify-center items-center lg:justify-start gap-8 lg:gap-0 lg:px-16 xl:px-24 xl:pt-24">
